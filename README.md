O arquivo 'base_vendas_2020_original.xlsx' é a base de dados cedida para o teste. Antes de iniciar as etapas do teste, este arquivo foi convertido para o formato csv para ingestão no banco de dados.
